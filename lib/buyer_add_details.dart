...
class BuyerAddDetails extends StatefulWidget {
  final Item? item;

  const BuyerAddDetails({Key? key, this.item}) : super(key: key);

  @override
  _BuyerAddDetailsState createState() => _BuyerAddDetailsState();
}

class _BuyerAddDetailsState extends State<BuyerAddDetails> {
